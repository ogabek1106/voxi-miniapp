...
UserListening.getQuestionIdFromField = function (field) {
...
UserListening.collectAnswers = function () {
  ...
  fields.forEach((field) => {
    const qid = UserListening.getQuestionIdFromField(field);
    if (!qid) return;
...
UserListening.getAnsweredQuestionIds = function () {
...
UserListening.collectSaveableAnswers = function () {
  const answers = UserListening.collectAnswers();
  const result = {};
